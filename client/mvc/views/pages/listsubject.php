    <header class="py-4 py-md-5" style="background-image: none;">
        <div class="container text-center py-xl-2">
            <h1 class="display-4 fw-semi-bold mb-0">Môn học</h1>

        </div>
        <!-- Img -->
        <img class="d-none img-fluid" src="...html" alt="...">
    </header>
    <div class="container mb-6 mb-xl-8 z-index-2 mt-5">
        <div class="d-xl-flex align-items-center">
            <p class="mb-xl-0">Tất cả <span class="text-dark"><?php echo count($data['result'])?>  </span>môn học </p>
            <div class="ms-xl-auto d-xl-flex flex-wrap">
                <div class="mb-4 mb-xl-0 ms-xl-6">
                    <!-- Search -->
                    <form class="">
                        <div class="input-group input-group-filter">
                            <input class="form-control form-control-sm placeholder-dark border-end-0 shadow-none" type="search" placeholder="Tìm kiếm..." aria-label="Search">
                                            ...
                                            <li class="nav-item px-3">
                                                <div class="row mx-n2 align-items-end mh-50">
                                                    ...
                                                    <div class="col-auto px-2 text-right">
                                                        <a href="../../quiz/" class="btn btn-primary py-1">Làm ngay</a>
                                                    </div>
