<header class="py-4 py-md-5" style="background-image: none;">
    <div class="container text-center py-xl-2">
        <h1 class="display-4 fw-semi-bold mb-0">Giới thiệu</h1>
    ...
    <div class="container pb-4 pb-xl-7">
        <div class="text-center mb-md-6 mb-4">
            <h1 class="mb-3">Poly Learning</h1>
            <p class="font-size-lg mb-5 text-capitalize">Là đội ngủ của FPT Polytechnic tạo ra nhằm phục vụ cho sinh viên rèn luyện kiến thức . </p>

            <p class="w-xl-80 mx-auto line-height-md">
                Poly Learning là một website giúp sinh viên rèn luyện , kiểm tra kiến thức ở các môn học ở trên trường cũng như kiến thức xã hội thông qua hình thức trả lời trắc nghiệm. Các câu hỏi trắc nghiệm trong Poly Learning thuộc nhiều danh mục  khác nhau để  tất cả sinh viên đều được tham gia thử sức, đánh giá trình độ của bản thân;  Nhìn chung, Poly Learning phù hợp với cả việc học tại nhà và trên lớp.
            </p>
        </div>
        ...
        ================================================== -->
        <div class="mb-8">
            <div class="py-12 py-md-14 bg-cover rounded text-center" style="background-image: url(../../public/client/assets/img/poly2.png);">
                <!-- Button -->
                <a href="https://www.youtube.com/watch?v=P9c-gQiie0M" class="btn h-90p w-90p rounded-circle btn-white size-30-all d-inline-flex align-items-center justify-content-center shadow lift text-dark" data-fancybox>
                    <!-- Icon -->
        ...
        <div class="pb-8 bg-white">
            <div class="row text-center">
                <div class="col-md-3 mb-6 mb-md-0">
                    <div class="h1 mb-1"><span data-toggle="countup" data-from="0" data-to="4" data-aos data-aos-id="countup:in"></span></div>
                    <p class="font-size-lg fw-medium mb-0">Danh mục</p>
                </div>

                <div class="col-md-3 mb-6 mb-md-0">
                    <div class="h1 mb-1"><span data-toggle="countup" data-from="0" data-to="13" data-aos data-aos-id="countup:in"></span></div>
                    <p class="font-size-lg fw-medium mb-0">Môn học</p>
                </div>

                <div class="col-md-3 mb-6 mb-md-0">
                    <div class="h1 mb-1"><span data-toggle="countup" data-from="0" data-to="5" data-aos="" data-aos-id="countup:in"></span>k+</div>
                    <p class="font-size-lg fw-medium mb-0">Câu hỏi</p>
                </div>

                <div class="col-md-3 mb-6 mb-md-0">
                    <div class="h1 mb-1"><span data-toggle="countup" data-from="0" data-to="53" data-aos="" data-aos-id="countup:in"></span>k+</div>
                    <p class="font-size-lg fw-medium mb-0">Thành viên</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="py-5 pt-md-11 pb-md-10 bg-light text-center">
        <div class="container">
            <div class="mb-md-8 mb-4">
                <h1>Đăng ký học ?</h1>
                <p class="font-size-lg mb-0 text-capitalize">Sinh viên có thể làm theo các bước bên dưới</p>
            </div>
            ...
            <div class="row">
                <div class="col-md-4 mb-4 mb-md-0">
                    ...
                    <h4 class="mb-1">Truy cập vào Poly Learning</h4>
                    <p class="px-lg-7 px-xl-8">Nhập vào google với địa chỉ http://polylearning.com</p>
                </div>
                ...
                <div class="col-md-4 mb-4 mb-md-0">
                    ...
                    <h4 class="mb-1">Đăng ký | Đăng nhập tài khoản</h4>
                    <p class="px-lg-7 px-xl-8">Đăng nhập với tư cách thành viên để được tham gia vào bài Quiz</p>
                </div>
                ...
                <div class="col-md-4 mb-4 mb-md-0">
                    ...
                    <h4 class="mb-1">Làm Quiz</h4>
                    <p class="px-lg-7 px-xl-8">Trên thanh menu click vào Môn học để đi đến danh sách môn học , và sau đó lựa chọn môn học muốn làm và click vào Làm Ngay</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- TESTIMONIAL
    ================================================== -->
    <section class="py-8 pt-xl-11 pb-xl-9 bg-white" style="display:none;">
