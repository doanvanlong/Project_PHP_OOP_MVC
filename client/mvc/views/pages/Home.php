    ...
    <div class="position-absolute right-0 left-0 top-0 bottom-0">
        <div class="cs-parallax">
            <div class="cs-parallax-layer" data-depth="0.1">
                <img class="img-fluid" src="../../public/client/assets/img/parallax/layer-01.svg" alt="Layer">
            </div>
            <div class="cs-parallax-layer" data-depth="0.3">
                <img class="img-fluid" src="../../public/client/assets/img/parallax/layer-02.svg" alt="Layer">
            </div>
            <div class="cs-parallax-layer" data-depth="0.2">
                <img class="img-fluid" src="../../public/client/assets/img/parallax/layer-03.svg" alt="Layer">
            </div>
            <div class="cs-parallax-layer" data-depth="0.2">
                <img class="img-fluid" src="../../public/client/assets/img/parallax/layer-04.svg" alt="Layer">
            </div>
            <div class="cs-parallax-layer" data-depth="0.4">
                <img class="img-fluid" src="../../public/client/assets/img/parallax/layer-05.svg" alt="Layer">
            </div>
            <div class="cs-parallax-layer" data-depth="0.3">
                <img class="img-fluid" src="../../public/client/assets/img/parallax/layer-06.svg" alt="Layer">
            </div>
            <div class="cs-parallax-layer" data-depth="0.2">
                <img class="img-fluid" src="../../public/client/assets/img/parallax/layer-07.svg" alt="Layer">
            </div>
            <div class="cs-parallax-layer" data-depth="0.2">
                <img class="img-fluid" src="../../public/client/assets/img/parallax/layer-08.svg" alt="Layer">
            </div>
            <div class="cs-parallax-layer" data-depth="0.4">
                <img class="img-fluid" src="../../public/client/assets/img/parallax/layer-09.svg" alt="Layer">
            </div>
            <div class="cs-parallax-layer" data-depth="0.3">
                <img class="img-fluid" src="../../public/client/assets/img/parallax/layer-10.svg" alt="Layer">
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12 col-md-5 col-lg-6 order-md-2" data-aos="fade-in">
                ...
                <!-- Image -->
                <img src="../../public/client/assets/img/illustrations/illustration-4.png" class="img-fluid ms-xl-5 mw-md-150 mw-lg-130 mb-6 mb-md-0" alt="...">

            </div>
            <div class="col-12 col-md-7 col-lg-6 order-md-1">
                <!-- Heading -->
                <h1 class="display-2 text-white mb-6" data-aos="fade-left" data-aos-duration="150">
                    Hệ thống ôn luyện <span class="display-1 text-orange fw-bold">Poly Learning</span>
                </h1>
                ...
                <form class="mb-6 me-xl-9" data-aos="fade-up" data-aos-duration="200">
                    <div class="input-group">
                        ...
                        <input type="search" class="form-control ps-2 border-left-0 rounded-right-xl border-0" placeholder="Tìm kiếm...">
                    </div>
                </form>
                    ...
                    <div class="card border rounded-xl shadow p-2 lift sk-fade">
                        ...
                        <div class="card-zoom position-relative">
                            <div class="badge-float sk-fade-top top-0 right-0 mt-4 me-4">
                                <a href="../../quiz/first/<?=$subject['id']?>" class="btn btn-xs btn-dark text-white rounded-circle lift opacity-dot-7 me-1 p-2 d-inline-flex justify-content-center align-items-center w-36 h-36">
                                    <!-- Icon -->
                                ...
                                <a href="../../quiz/first/<?=$subject['id']?>" class="btn btn-xs btn-dark text-white rounded-circle lift opacity-dot-7 p-2 d-inline-flex justify-content-center align-items-center w-36 h-36">
                                    <!-- Icon -->
                            ...
                            <a href="../../quiz/first/<?=$subject['id']?>" class="card-img sk-thumbnail d-block">
                                <img class="rounded shadow-light-lg" src="../../../admin/public/upload/<?php echo trim($subject['subject_img']); ?>" alt="...">
                            </a>

                            <span class="badge sk-fade-bottom badge-lg badge-orange badge-pill badge-float bottom-0 left-0 mb-4 ms-4">
                                <span class="text-white text-uppercase fw-bold font-size-xs">Mới</span>
                            </span>
                        </div>
                        ...
                        <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                            <a href="instructors-single.html" class="d-block">
                                <div class="avatar sk-fade-right avatar-xl badge-float position-absolute top-0 right-0 mt-n6 me-5 rounded-circle shadow border border-white border-w-lg">
                                    <img src="../../public/client/assets/img/fpt.jpg" alt="..." class="avatar-img rounded-circle">
                                </div>
                            </a>

                            <!-- Preheading -->
                            <a href="../../quiz/first/<?=$subject['id']?>"><span class="mb-1 d-inline-block text-gray-800"></span></a>

                            <!-- Heading -->
                            <div class="position-relative">
                                <a href="../../quiz/first/<?=$subject['id']?>" class="d-block stretched-link">
                                    <h4 class="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2"><?= $subject['subject_name'] ?></h4>
                                </a>
                                                        ...
                                                        <ul class="nav mx-n3">
                                                            <li class="nav-item px-3">
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="font-size-sm">10 Câu hỏi</div>
                                                                </div>
                                                            </li>
                                                            <li class="nav-item px-3">
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="font-size-sm">10 phút</div>
                                                                </div>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-auto px-2 text-right">
                                                        <a class="btn btn-primary py-1">Làm ngay</a>
                                                    </div>
...
<section class="py-6 py-md-12 jarallax" data-jarallax data-speed=".8" style="background-image: url(../../public/client/assets/img/illustrations/illustration-5.jpg)">
    <div class="container text-center py-xl-7 text-capitalize" data-aos="fade-up">
        <h1>Bắt đầu ôn luyện thôi nào</h1>
        <div class="font-size-lg mb-md-6 mb-4">Có công mài sắt , có ngày qua môn</div>
        <div class="mx-auto">
            <a href="" class="btn btn-dark btn-x-wide lift d-inline-block rounded-xl">Bắt đầu</a>
        </div>
    </div>
</section>