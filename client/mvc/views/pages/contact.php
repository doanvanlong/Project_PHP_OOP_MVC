<header class="py-4 py-md-5" style="background-image: none;">
    <div class="container text-center py-xl-2">
        <h1 class="display-4 fw-semi-bold mb-0">Liên hệ</h1>
...
<div class="container">
    ...
    <div class="row my-4">
        <div class="col-6">
            <div class="row">
                <div class="col-12">
                    ...
                    <label class="form-control" for="">
                        <p>137 Nguyễn Thị Thập - Hoà Minh - Liên Chiểu - Đà Nẵng</p>
                    </label>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <p>polylearning.contact@gmail.com</p>
                </label>
                </div>
            </div>
            <div class="row">
        ...
        <div class="col-6">
            ...
            <div class="row my-4">
                <div class="col-12">
                    <div class="btn btn-primary py-2">Gửi liên hệ</div>
                </div>
            </div>
        </div>
    </div>
